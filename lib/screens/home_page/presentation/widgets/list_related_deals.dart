...
class RelatedDeals extends StatelessWidget {
  RelatedDeals({super.key, required this.type,  this.dealModel, required this.onSelected});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: dealModel== null ? _homePageController.getDealProducts(1,{"discount": "10"}) : _homePageController.getRelatedDeals(dealModel!.id),
      builder: (context, snap) {
        ...
        if (snap.connectionState == ConnectionState.done && !snap.hasError) {
          ...
          return type ==RelatedDealsType.list ? listType(context, relatedDeals) : gridType(context, relatedDeals);
        }
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: item.isFavorite ? SvgPicture.asset(
                                          ...
                                          width: 15,
                                        ) : Icon(Icons.favorite_border,color: HexColor.fromHex(AppTheme.textFieldBorder),),
                                      ),
                                    ),
                                  )
                                ],
